...
class AudiosControllerTest < ActionController::TestCase
  ...
  test "should create audio" do
    assert_difference('Audio.count') do
      post :create, audio: { audioname: @audio.audioname, flocation: @audio.flocation, status: @audio.status }
    end
  ...
  test "should update audio" do
    patch :update, id: @audio, audio: { audioname: @audio.audioname, flocation: @audio.flocation, status: @audio.status }
    assert_redirected_to audio_path(assigns(:audio))
  end
